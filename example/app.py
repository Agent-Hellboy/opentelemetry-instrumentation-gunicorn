...
otel_endpoint = os.environ.get("OTEL_EXPORTER_OTLP_METRICS_ENDPOINT") or os.environ.get("OTEL_EXPORTER_OTLP_ENDPOINT")
if otel_endpoint:
...
resource = Resource.create({"service.name": os.environ.get("OTEL_SERVICE_NAME", "gunicorn-app")})
otel_metrics.set_meter_provider(MeterProvider(metric_readers=metric_readers, resource=resource))
